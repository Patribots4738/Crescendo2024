...
public class Elevator extends SubsystemBase implements Logged {
    ...
    public void periodic() {
        ...
        updateStuck();
        LoggedValues.components3d[NTConstants.AMPPER_INDEX] = new Pose3d(
            0, 0, position * ElevatorConstants.AMPPER_POSITION_MULTIPLIER, 
            new Rotation3d()
        );
        LoggedValues.components3d[NTConstants.ELEVATOR_INDEX] = new Pose3d(
            0, 0, position,
            new Rotation3d()
        );
    }
    ...
    public void setPosition(double pos) {
        ...
        if (desiredPos != pos) {
            ...
            LoggedValues.desiredComponents3d[NTConstants.ELEVATOR_INDEX] = new Pose3d(
                0, 0, pos,
                new Rotation3d()
            );
            LoggedValues.desiredComponents3d[NTConstants.AMPPER_INDEX] = new Pose3d(
