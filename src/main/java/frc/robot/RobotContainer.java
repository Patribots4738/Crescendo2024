...
public class RobotContainer implements Logged {
    ...
    // TODO: uncomment these bindings (they are commented because we aren't testing
    // them)
                                ...
                                swerve.getDriveCommand(
                                        () -> {
                                            ...
                                            return new ChassisSpeeds(
                                                    -controller.getLeftY(),
                                                    -controller.getLeftX(),
                                                    swerve.getAlignmentSpeeds(shooterCalc
                                                            .calculateSWDRobotAngleToSpeaker(swerve.getPose(),
